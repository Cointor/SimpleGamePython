...
pygame.display.set_caption("Te amo Jaqueline")

# Cargar imágenes y escalarlas
player_image = pygame.image.load("cris.png")
player_image = pygame.transform.scale(player_image, (60, 60))

bullet_image = pygame.image.load("kiwi.png")
bullet_image = pygame.transform.scale(bullet_image, (50, 50))   

enemy_image = pygame.image.load("jaq.png")
